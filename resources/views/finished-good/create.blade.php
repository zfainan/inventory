...
@section('content')
    <h2 class="h4">Tambah Data Hasil Cetak</h2>
    ...
    <div class="card my-4">
        <div class="card-body">
            <form action="{{ route('finished-goods.store') }}" method="post">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="input-judul" disabled>
                </div>

                <div class="mb-3">
                    <label for="input-exp" class="form-label">Exp</label>
                    <input type="text" class="form-control" id="input-exp" disabled>
                </div>

                <div class="mb-3">
                    <label for="input-isbn" class="form-label">ISBN</label>
                    <input type="text" class="form-control" id="input-isbn" disabled>
                </div>

                <div class="mb-3">
                    <label for="input-penerbit" class="form-label">Penerbit</label>
                    <input type="text" class="form-control" id="input-penerbit" disabled>
                </div>
