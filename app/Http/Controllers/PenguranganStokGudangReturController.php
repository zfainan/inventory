...
class PenguranganStokGudangReturController extends Controller
{
    /**
    ...
    public function __invoke(Request $request)
    {
        ...
        try {
            ...
            $inventory = Inventory::gudangRetur()->findOrFail($request->id_inventory);

            if ($inventory->stok < $request->qty) {
                throw new LogicException("Stok buku kurang dari {$request->qty}.");
            }
